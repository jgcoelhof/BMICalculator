...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Calculadora de IMC"), centerTitle: true, backgroundColor: Colors.green, actions: [
        IconButton(
      ...
      body: SingleChildScrollView(padding
        ...
        Container(padding:EdgeInsets.only(top: 10,right: 0.0, bottom: 10.0),height:50.0,child:
